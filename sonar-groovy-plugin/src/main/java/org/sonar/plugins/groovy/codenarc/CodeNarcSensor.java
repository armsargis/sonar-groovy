...
public class CodeNarcSensor implements Sensor {
    ...
    public CodeNarcSensor(GroovyFileSystem groovyFileSystem) {
    ...
    private void runCodeNarc(SensorContext context) {
        ...
        exportCodeNarcConfiguration(context.activeRules(), codeNarcConfiguration);
    ...
    private void exportCodeNarcConfiguration(ActiveRules activeRules, File file) {
        try {
